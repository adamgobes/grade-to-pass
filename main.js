...
var _user$project$Main$calculate = function (model_) {
	var computeFinalWeight = F2(
		function (total, index) {
			if (_elm_lang$core$Native_Utils.cmp(index, model_.numComponents - 1) > 0) {
				return total;
			} else {
				var currentComponent = A2(
					_elm_lang$core$Maybe$withDefault,
					{weight: 0, percentage: 0},
					A2(_elm_lang$core$Array$get, index, model_.components));
				var newTotal = total + _elm_lang$core$Basics$round(currentComponent.weight);
				return 100 - A2(computeFinalWeight, newTotal, index + 1);
			}
		});
	var withoutFinal = F2(
		function (total, index) {
...
var _user$project$Main$convertRawInt = function (str) {
	return A2(
		_elm_lang$core$Result$withDefault,
		0,
		_elm_lang$core$String$toInt(str));
};
var _user$project$Main$convertRawFloat = function (str) {
	return A2(
		_elm_lang$core$Result$withDefault,
		0,
			...
			case 'ComponentInc':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model_,
						{
							numComponents: model_.numComponents + 1,
							components: A2(
			...
			case 'ComponentDec':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							numComponents: model_.numComponents - 1,
							components: A3(_elm_lang$core$Array$slice, 0, model_.numComponents - 1, model_.components)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ComponentWeight':
				...
				var record = A2(
					...
					A2(
						...
						_user$project$Main$convertRawInt(_p2),
						model_.components));
			...
			case 'Submit':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model_,
						{
							gradeToPass: _user$project$Main$calculate(model_)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$ComponentWeight = F2(
	function (a, b) {
		return {ctor: 'ComponentWeight', _0: a, _1: b};
	});
var _user$project$Main$renderComponents = function (model_) {
	var inputs = A2(
		_elm_lang$core$List$repeat,
		model_.numComponents,
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
			...
			},
			{
				...
				_1: {
					...
					_0: A4(
						...
						{
							ctor: '::',
							_0: _elm_lang$core$Tuple$first(tuple) + 13,
							_1: {ctor: '[]'}
						},
						model_.mdl,
						{
...
var _user$project$Main$ComponentInc = {ctor: 'ComponentInc'};
